...
const sendStat = (type) => {
  ...
  else if (lang.startsWith("fr")) country = "BE";
...
const TEXT = {
  en: {
    heroTitle: "Stop overpaying electricity.",
    heroSub: "Just follow the color.",
    heroDesc: "A simple device that tells you the best moment to use electricity.",
    cta: "Get mine now — €29",
    how: "How it works",
    legendCheap: "Cheap",
    legendNormal: "Normal",
    legendExpensive: "Expensive",
    noApp: "No app. No setup. Just look at the color and decide in seconds.",
    badges: ["Secure checkout", "Free shipping", "14-day returns", "2-year warranty"],
    ...
    heroClarify: "Shows when it's cheaper — does not control your appliances.",
    productLiteTitle: "V2 Lite",
    productLiteDesc: "Instant visual signal. No app needed.",
    productLitePoints: ["Green / Yellow / Red signal", "No app needed", "Simple for everyday use"],
    productLiteOptions: [
      { label: "☀️ Solar panel (+9€)", desc: "works without outlet" },
      { label: "🔋 Powerbank (+15€)", desc: "works at night" },
    ],
    ...
    productScreenDesc: "Live price, time and status in your language.",
    productScreenPoints: ["Live price display", "Time + status", "More detailed view"],
    ...
    trust1Desc: "A real working device designed to make electricity decisions simpler.",
    ...
    trust3Desc: "Payments handled through Stripe, with legal pages and cookie choices clearly available.",
    usageLine: "Perfect for washing machine, dishwasher or dryer.",
    cookieTitle: "Cookie choice",
    cookieDesc: "We only use cookies if you accept. You can refuse and continue browsing normally.",
    cookieAccept: "Accept",
    cookieRefuse: "Refuse",
    ...
    howDesc: "BlockPulse reads electricity price signals and turns them into a simple color.",
  ...
  fr: {
    heroTitle: "Arrêtez de payer trop cher.",
    heroSub: "Suivez la couleur.",
    ...
    noApp: "Pas d'application. Pas de configuration. Regardez la couleur et décidez en quelques secondes.",
    badges: ["Paiement sécurisé", "Livraison gratuite", "Retour 14 jours", "Garantie 2 ans"],
    ...
    heroClarify: "Indique quand l'électricité est moins chère — ne contrôle pas vos appareils.",
    productLiteTitle: "V2 Lite",
    productLiteDesc: "Signal visuel instantané. Aucune application nécessaire.",
    productLitePoints: ["Signal vert / jaune / rouge", "Pas d'application", "Simple à utiliser"],
    productLiteOptions: [
      { label: "☀️ Panneau solaire (+9€)", desc: "fonctionne sans prise" },
      { label: "🔋 Powerbank (+15€)", desc: "autonomie la nuit" },
    ],
    ...
    productScreenDesc: "Prix en temps réel, heure et statut dans votre langue.",
    productScreenPoints: ["Prix en temps réel", "Heure + statut", "Vue détaillée"],
    ...
    usageLine: "Parfait pour machine à laver, lave-vaisselle ou sèche-linge.",
    ...
    howDesc: "BlockPulse lit les signaux de prix de l'électricité et les transforme en une couleur simple.",
  ...
  de: {
    heroTitle: "Zahlen Sie nicht zu viel für Strom.",
    heroSub: "Folgen Sie der Farbe.",
    ...
    noApp: "Keine App. Keine Einrichtung. Einfach Farbe ansehen und entscheiden.",
    badges: ["Sichere Zahlung", "Kostenloser Versand", "14 Tage Rückgabe", "2 Jahre Garantie"],
    ...
    heroClarify: "Zeigt wann Strom günstiger ist — steuert keine Geräte.",
    productLiteTitle: "V2 Lite",
    productLiteDesc: "Sofortiges visuelles Signal. Keine App nötig.",
    productLitePoints: ["Grün / Gelb / Rot Signal", "Keine App nötig", "Einfach zu bedienen"],
    productLiteOptions: [
      { label: "☀️ Solarpanel (+9€)", desc: "funktioniert ohne Steckdose" },
      { label: "🔋 Powerbank (+15€)", desc: "funktioniert nachts" },
    ],
    ...
    productScreenPoints: ["Live Preis", "Zeit + Status", "Mehr Details"],
    ...
    usageLine: "Perfekt für Waschmaschine, Geschirrspüler oder Trockner.",
    ...
    howDesc: "BlockPulse liest Strompreissignale und wandelt sie in eine einfache Farbe um.",
  ...
  nl: {
    heroTitle: "Betaal niet te veel voor elektriciteit.",
    heroSub: "Volg gewoon de kleur.",
    ...
    noApp: "Geen app. Geen installatie. Kijk gewoon naar de kleur en beslis direct.",
    badges: ["Veilige betaling", "Gratis verzending", "14 dagen retour", "2 jaar garantie"],
    ...
    heroClarify: "Toont wanneer stroom goedkoper is — stuurt geen apparaten aan.",
    productLiteTitle: "V2 Lite",
    productLiteDesc: "Direct visueel signaal. Geen app nodig.",
    productLitePoints: ["Groen / geel / rood signaal", "Geen app nodig", "Eenvoudig in gebruik"],
    productLiteOptions: [
      { label: "☀️ Zonnepaneel (+9€)", desc: "werkt zonder stopcontact" },
      { label: "🔋 Powerbank (+15€)", desc: "werkt 's nachts" },
    ],
    ...
    productScreenDesc: "Realtime prijs, tijd en status in jouw taal.",
    productScreenPoints: ["Live prijs", "Tijd + status", "Meer details"],
    ...
    usageLine: "Perfect voor wasmachine, vaatwasser of droger.",
    ...
    howDesc: "BlockPulse leest elektriciteitsprijssignalen en zet die om in een eenvoudige kleur.",
...
export default function App() {
  ...
  return (
    <Routes>
      <Route
        ...
        element={
          <div className="bg-white text-slate-900">
            ...
            {/* ── NAVBAR ── */}
            <nav
              className="sticky top-0 z-30 border-b border-white/20 bg-white/80 backdrop-blur-md"
            >
              <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
                <div className="flex items-center gap-2 text-xl font-extrabold">
                  <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-emerald-600 text-white text-xs font-bold shadow">
                    ⚡
                  </div>
                ...
                <div className="flex items-center gap-3">
                  {/* Colour legend — hidden on very small */}
                  <div className="hidden items-center gap-3 rounded-full bg-emerald-50 border border-emerald-200 px-4 py-1.5 text-xs font-semibold text-slate-800 sm:flex">
                  ...
                  <div className="hidden items-center gap-1.5 rounded-full bg-white/90 border border-slate-200 px-3 py-1.5 text-xs font-semibold text-emerald-900 shadow-sm sm:inline-flex">
            ...
            <section className="relative overflow-hidden">
              ...
              />
              {/* wind turbine illustration — desktop only */}
              <img
                src={wind}
                aria-hidden="true"
              ...
              />
              {/* gradient overlay — lighter so background shows */}
              <div className="absolute inset-0 bg-gradient-to-br from-white/75 via-white/40 to-white/10" />
              ...
              <div className="relative z-10 mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                ...
                <div className="grid items-start gap-8 lg:grid-cols-[1fr_1.6fr]">
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="mb-4 inline-flex w-fit rounded-full bg-white/90 px-4 py-1.5 text-xs font-semibold text-emerald-800 shadow-sm ring-1 ring-emerald-200">
                      🟢 Real working device — Not a concept
                    </div>

                    <h1 className="text-3xl font-extrabold leading-tight text-emerald-950 sm:text-4xl lg:text-5xl">
                      {t.heroTitle}
                      <span className="block text-emerald-600">{t.heroSub}</span>
                    </h1>
                    ...
                    {/* info clarify */}
                    <div className="mt-3 inline-flex w-fit max-w-sm rounded-xl bg-white/80 px-4 py-2 text-sm font-medium text-slate-600 shadow-sm ring-1 ring-slate-200">
                      ℹ️ {t.heroClarify}
                    </div>

                    {/* usage hint */}
                    <div className="mt-3 inline-flex w-fit max-w-sm items-center gap-2 rounded-xl bg-emerald-50 border border-emerald-200 px-3 py-2 text-sm font-medium text-emerald-900">
                      ⚡ {t.usageLine}
                    </div>
                    ...
                    <button
                      onClick={scrollToHow}
                      className="mt-6 inline-flex w-fit items-center gap-2 rounded-2xl bg-white/90 px-5 py-2.5 text-sm font-bold text-slate-800 shadow ring-1 ring-slate-200 transition hover:bg-white"
                    >
                      {t.how} ↓
                    </button>
                  </div>

                  {/* RIGHT — both product cards side by side */}
                  <div id="products" className="grid grid-cols-1 gap-4 sm:grid-cols-2">

                    {/* V2 LITE */}
                    <div className="relative flex flex-col rounded-3xl bg-white p-4 shadow-xl ring-2 ring-emerald-500">
                      <div className="mb-2 flex items-center justify-between">
                        <span className="rounded-full bg-emerald-100 px-2.5 py-1 text-xs font-bold text-emerald-800">
                          🔥 Most popular
                        </span>
                        <span className="text-xs font-semibold text-orange-500">{t.productLiteUrgency}</span>
                      </div>

                      <div className="overflow-hidden rounded-2xl bg-slate-50">
                        <img
                          src={deviceLite}
                          alt={t.productLiteTitle}
                          className="h-44 w-full object-cover"
                        />
                      </div>

                      <h3 className="mt-3 text-lg font-bold text-slate-900">{t.productLiteTitle}</h3>
                      <p className="mt-0.5 text-sm text-slate-500">{t.productLiteDesc}</p>

                      <div className="mt-2 flex items-baseline gap-2">
                        <span className="text-2xl font-extrabold text-emerald-700">€{totalPrice}</span>
                        <span className="text-sm text-slate-400 line-through">€39</span>
                      </div>

                      <p className="mt-1 text-xs font-semibold text-emerald-700">🌍 {t.shipping}</p>

                      <ul className="mt-2 space-y-1 text-sm text-slate-600">
                        {t.productLitePoints.map((p) => (
                      ...
                      <div className="mt-3 rounded-xl bg-emerald-50 border border-emerald-200 p-3 space-y-2">
                        {t.productLiteOptions.map((o, i) => (
                          <label key={i} className="flex items-start gap-2 cursor-pointer text-xs text-slate-700">
                            <input
                              type="checkbox"
                      ...
                      <button
                        onClick={() => { sendStat("click"); startCheckout("lite", selectedOptions); }}
                        disabled={isLoading}
                      ...
                      >
                        {isLoading ? "Loading..." : t.productLiteButton}
                      </button>
                      <p className="mt-2 text-center text-xs text-slate-400">{t.productLiteSub}</p>
                    </div>

                    {/* SCREEN */}
                    <div className="flex flex-col rounded-3xl bg-white p-4 shadow-xl ring-1 ring-slate-200">
                      <div className="mb-2">
                      ...
                      <div className="overflow-hidden rounded-2xl bg-slate-50">
                        <img
                          src={deviceScreen}
                          alt={t.productScreenTitle}
                          className="h-44 w-full object-cover"
                        />
                      </div>

                      <h3 className="mt-3 text-lg font-bold text-slate-900">{t.productScreenTitle}</h3>
                      <p className="mt-0.5 text-sm text-slate-500">{t.productScreenDesc}</p>

                      <div className="mt-2 flex items-baseline gap-2">
                        <span className="text-2xl font-extrabold text-slate-800">€69</span>
                      </div>

                      <p className="mt-1 text-xs font-semibold text-emerald-700">🌍 {t.shipping}</p>

                      <ul className="mt-2 space-y-1 text-sm text-slate-600">
                        {t.productScreenPoints.map((p) => (
                          <li key={p} className="flex items-center gap-1.5">
                            <span className="text-emerald-500 font-bold">✓</span> {p}
                          </li>
                        ))}
                      ...
                      <button
                        onClick={() => { sendStat("click"); startCheckout("standard"); }}
                        disabled={isLoading}
                        className="mt-4 w-full rounded-xl bg-slate-800 py-3 text-sm font-bold text-white transition hover:bg-slate-900 disabled:opacity-50"
                      >
                        {isLoading ? "Loading..." : t.productScreenButton}
                      </button>
                      <p className="mt-2 text-center text-xs text-slate-400">{t.productScreenSub}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section id="how" className="bg-stone-50 py-16">
              <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
                ...
                <div className="mx-auto mt-6 max-w-2xl rounded-2xl bg-emerald-50 border border-emerald-200 p-5 text-left shadow-sm">
                  <ul className="space-y-1 text-sm text-slate-700">
                    <li>🟢 {t.howExplainGreen}</li>
                    <li>🟡 {t.howExplainYellow}</li>
                    <li>🔴 {t.howExplainRed}</li>
                  </ul>
                  <p className="mt-2 text-sm text-slate-500">{t.howExplain2}</p>
                </div>
            ...
            <section className="py-14">
              <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <div className="rounded-3xl bg-white p-6 shadow-lg ring-1 ring-slate-200 sm:p-8">
                  <h2 className="text-xl font-bold text-emerald-950">{t.trustTitle}</h2>
                  <div className="mt-6 grid gap-4 md:grid-cols-3">
                    <TrustItem title={t.trust1Title} text={t.trust1Desc} />
                    <TrustItem title={t.trust2Title} text={t.trust2Desc} />
                    <TrustItem title={t.trust3Title} text={t.trust3Desc} />
                  </div>
                </div>
              </div>
            </section>
            ...
            <footer className="bg-emerald-950 text-white">
              <div className="mx-auto max-w-7xl px-6 py-12">
                <div className="grid grid-cols-1 gap-10 text-left sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <div className="flex flex-col items-start gap-2 text-sm text-emerald-100/80">
                      <button onClick={scrollToHow} className="text-left hover:text-white transition">
                        {t.footerHow}
                      </button>
                      <Link to="/blog" className="hover:text-white transition">{t.footerBlog}</Link>
                      <Link to="/faq" className="hover:text-white transition">{t.footerFAQ}</Link>
                      <button onClick={() => { sendStat("click"); startCheckout("lite", selectedOptions); }} className="text-left hover:text-white transition">
                        {t.footerOrderLite}
                      </button>
                      <button onClick={() => { sendStat("click"); startCheckout("standard"); }} className="text-left hover:text-white transition">
                        {t.footerOrderScreen}
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <div className="flex flex-col items-start gap-2 text-sm text-emerald-100/80">
                      <button onClick={() => openModal("legal")} className="text-left hover:text-white transition">{t.footerLegalNotice}</button>
                      <button onClick={() => openModal("privacy")} className="text-left hover:text-white transition">{t.footerPrivacy}</button>
                      <button onClick={() => openModal("cookies")} className="text-left hover:text-white transition">{t.footerCookies}</button>
                      <button onClick={reopenCookieBanner} className="text-left hover:text-white transition">{t.footerManageCookies}</button>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <div className="flex flex-col items-start gap-2 text-sm text-emerald-100/80">
                      ...
                      <a href="https://www.linkedin.com/in/christophe-devleeshouwer-882377399/" target="_blank" rel="noreferrer" className="hover:text-white transition">LinkedIn</a>
                      <a href="https://www.tiktok.com/@blockpulse_be" target="_blank" rel="noreferrer" className="hover:text-white transition">TikTok</a>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-6 text-center text-xs text-emerald-100/60">© 2026 BlockPulse</div>
              </div>
            </footer>
              ...
              <div className="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white shadow-2xl">
                <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
                  <div className="max-w-3xl">
                    <div className="text-sm font-bold text-slate-900">{t.cookieTitle}</div>
                    <p className="mt-1 text-sm text-slate-600">{t.cookieDesc}</p>
                  </div>
                  <div className="flex flex-col gap-2 sm:flex-row">
                    <button onClick={refuseCookies} className="rounded-xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-800 hover:bg-slate-50 transition">
                      {t.cookieRefuse}
                    </button>
                    <button onClick={acceptCookies} className="rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700 transition">
                      {t.cookieAccept}
                    </button>
                  </div>
                </div>
            ...
            {/* ── MODALS ── */}
            <LegalModal isOpen={activeModal === "legal"} title={t.legalTitle} onClose={closeModal} closeText={t.close}>
              <div className="space-y-4 text-sm leading-relaxed text-slate-700">
                <p>{t.legalText1}</p>
                <p>{t.legalText2}<br />{t.legalText3}<br />{t.legalText4}</p>
                <p>{t.legalText5}</p>
                <p>{t.legalText6}</p>
                <p>{t.legalText7}</p>
              </div>
            ...
            <LegalModal isOpen={activeModal === "privacy"} title={t.privacyTitle} onClose={closeModal} closeText={t.close}>
              <div className="space-y-4 text-sm leading-relaxed text-slate-700">
                <p>{t.privacyText1}</p>
                <p>{t.privacyText2}</p>
                <p>{t.privacyText3}</p>
            ...
            <LegalModal isOpen={activeModal === "cookies"} title={t.cookiesTitle} onClose={closeModal} closeText={t.close}>
              <div className="space-y-4 text-sm leading-relaxed text-slate-700">
                <p>{t.cookiesText1}</p>
                <p><strong>{t.cookiesText2}</strong></p>
                <p><strong>{t.cookiesText3}</strong></p>
                <p>
                  <strong>
                    {cookieConsent === "accepted" ? t.cookieAccept : cookieConsent === "refused" ? t.cookieRefuse : "..."}
                  </strong>
                </p>
                <button onClick={reopenCookieBanner} className="rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700 transition">
                  {t.cookiesChange}
                </button>
              </div>
            </LegalModal>
            ...
            {/* scroll to top */}
            {showTop && (
              <button onClick={scrollToTop} className="fixed bottom-5 right-5 z-40 rounded-full bg-emerald-600 px-4 py-2 text-white shadow-lg hover:bg-emerald-700 transition">
                ↑ Top
              </button>
            )}
          </div>
      ...
      <Route path="/blog/cheapest-electricity-netherlands" element={<BlogArticle5 />} />
...
function Step({ number, title, text }) {
  return (
    <div className="rounded-2xl bg-white p-6 shadow ring-1 ring-slate-200">
      <div className="text-lg font-bold text-slate-900">{number}. {title}</div>
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-900/70 p-4">
      <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-3xl bg-white shadow-2xl">
        <div className="sticky top-0 flex items-center justify-between border-b border-slate-200 bg-white px-5 py-4 sm:px-6">
          ...
          <button onClick={onClose} className="rounded-full px-3 py-1 text-sm font-semibold text-slate-500 hover:bg-slate-100 hover:text-slate-900 transition">✕</button>
        </div>
        <div className="px-5 py-5 sm:px-6">{children}</div>
        <div className="border-t border-slate-200 px-5 py-4 sm:px-6">
          <button onClick={onClose} className="rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700 transition">
            {closeText}
          </button>
        </div>
      </div>
